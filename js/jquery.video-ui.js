...
(function( $ ){
    ...
    $.fn.videoUI = function( options ) {  
        ...
        if (settings.playMedia){
            $('.'+controllerClass).append('<a href="#" class="playMedia"><i class="glyphicon glyphicon-play xxx-glyphicon-white" style="color:#fff;"></i></a>');                        
        ...
        if (settings.volumeMedia){
            ...
            var on='';
            var html = '<i class="mute glyphicon glyphicon-volume-up xxx-glyphicon-white" style="color:#fff;"></i><ul class="volumeMedia unstyled">';
            for(i=0;i<10;i++){
        ...
        if (settings.fullscreenMedia){
            $('.'+controllerClass).append('<i class="fullscreen glyphicon glyphicon-fullscreen xxx-glyphicon-white" style="color:#fff;"></i>');
