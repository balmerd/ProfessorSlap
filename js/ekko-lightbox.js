...
(function() {
  ...
  EkkoLightbox = function(element, options) {
    var content, footer, header, video_id,
      _this = this;
    this.options = $.extend({
      gallery_parent_selector: 'document.body', // was: '*:not(.row)',
      title: null,
      footer: null,
      remote: null,
...
//	/* added by Dave */
//	$('.ekko-lightbox .modal-footer').append('<button id="close-photo" class="btn btn-default btn-xs pull-right" type="button"><span class="glyphicon glyphicon-remove-circle"></span> Close</button>')
//	$('.ekko-lightbox .modal-footer').append('<button id="next-photo" class="btn btn-default btn-xs pull-right" type="button"><span class="glyphicon glyphicon-circle-arrow-right"></span> Next</button>')
//	$('.ekko-lightbox .modal-footer').append('<button id="prev-photo" class="btn btn-default btn-xs pull-right" type="button"><span class="glyphicon glyphicon-circle-arrow-left"></span> Previous</button>')
